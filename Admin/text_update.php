            ...
            <table width="700px" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" width="515px">
                        <?php
                        if(isset($title) and isset($meta_key) and isset($meta_desc) and isset($text)){
                            //заносим информацию в базу
                            $sql = mysqli_query($conn,"UPDATE options SET title ='$title',meta_key = '$meta_key',
                            meta_desc = '$meta_desc',text='$text' WHERE id='$id'");
                            if ($sql) {
                                echo "<p>Страница успешно обновлена</p>";
                            }else {
                                echo "<p>Ошибка, страница не обновлёна</p>";
                            }
                        }else{
                            echo "<p>Есть пустые поля. Страница не обновлена</p>";
                        }
                        ?>
                    </td>
                </tr>
